...
<Package name="Soin1" format_version="4">
    ...
    <Dialogs />
    <Resources>
        <File name="Aladdin - Ce rêve bleu" src="mp3/Aladdin - Ce rêve bleu.mp3" />
        <File name="Au clair de la lune" src="mp3/Au clair de la lune.mp3" />
