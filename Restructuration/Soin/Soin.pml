...
<Package name="Soin" format_version="4">
    ...
    <Dialogs />
    <Resources>
        <File name="Soin1" src="Soin1/Soin1.pml" />
        <File name="manifest" src="Soin1/manifest.xml" />
        <File name="Soin2" src="Soin2/Soin2.pml" />
        <File name="manifest" src="Soin2/manifest.xml" />
        <File name="Aladdin - Ce rêve bleu" src="Soin1/mp3/Aladdin - Ce rêve bleu.mp3" />
        <File name="Asterix et Cleopatre - Le Pudding à l&apos;arsenic" src="Soin1/mp3/Asterix et Cleopatre - Le Pudding à l&apos;arsenic.mp3" />
        <File name="Au clair de la lune" src="Soin1/mp3/Au clair de la lune.mp3" />
        <File name="Cendrillon - Bibbidi-Bobbidi-Boo" src="Soin1/mp3/Cendrillon - Bibbidi-Bobbidi-Boo.mp3" />
        <File name="Frère des ours - Je men vais" src="Soin1/mp3/Frère des ours - Je men vais.mp3" />
        <File name="Il court, il court, le furet" src="Soin1/mp3/Il court, il court, le furet.mp3" />
        <File name="Il Çtait un petit navire" src="Soin1/mp3/Il Çtait un petit navire.mp3" />
        <File name="Kendji Girac - Color Gitano" src="Soin1/mp3/Kendji Girac - Color Gitano.mp3" />
        <File name="La Belle et la Bête - Histoire éternelle" src="Soin1/mp3/La Belle et la Bête - Histoire éternelle.mp3" />
        <File name="La Petite Sirène - Sous locéan" src="Soin1/mp3/La Petite Sirène - Sous locéan.mp3" />
        <File name="La famille Tortue" src="Soin1/mp3/La famille Tortue.mp3" />
        <File name="Le Livre de la Jungle - Il en faut peu pour être heureux" src="Soin1/mp3/Le Livre de la Jungle - Il en faut peu pour être heureux.mp3" />
        <File name="Le Roi Lion - Hakuna Matata" src="Soin1/mp3/Le Roi Lion - Hakuna Matata.mp3" />
        <File name="Mulan- Comme un homme" src="Soin1/mp3/Mulan- Comme un homme.mp3" />
